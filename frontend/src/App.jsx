...
const DashboardIcon = ({ active }) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <rect x="2" y="2" width="5" height="5" rx="1.2" fill={active ? '#fff7ed' : '#fb923c'} />
    <rect x="9" y="2" width="5" height="8" rx="1.2" fill={active ? '#fdba74' : '#6b7280'} />
    <rect x="2" y="9" width="5" height="5" rx="1.2" fill={active ? '#fdba74' : '#6b7280'} />
    <rect x="9" y="12" width="5" height="2" rx="1" fill={active ? '#fff7ed' : '#fb923c'} />
  </svg>
);

const DevicesIcon = ({ active }) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <rect x="2" y="3" width="12" height="8" rx="1.5" stroke={active ? '#fff7ed' : '#fb923c'} strokeWidth="1.4" />
    <path d="M5 13h6" stroke={active ? '#fdba74' : '#9ca3af'} strokeWidth="1.4" strokeLinecap="round" />
    <path d="M7 11v2M9 11v2" stroke={active ? '#fdba74' : '#9ca3af'} strokeWidth="1.2" strokeLinecap="round" />
  </svg>
);
        ...
        >
          <div
            style={{
              ...
              height: 36,
              borderRadius: 12,
              background: 'linear-gradient(135deg, #f97316, #fb923c 55%, #fdba74)',
              display: 'flex',
              alignItems: 'center',
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#f97316', boxShadow: '0 0 0 3px rgba(249,115,22,0.22)' }} />
